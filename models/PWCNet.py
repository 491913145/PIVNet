...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.predict_flow5_2 = predict_flow(od + dd[2])
        self.deconv5 = deconv(2, 2, kernel_size=4, stride=2, padding=1)
        self.upfeat5 = deconv(od + dd[2], 2, kernel_size=4, stride=2, padding=1)
        ...
        self.predict_flow4_2 = predict_flow(od + dd[2])
        self.deconv4 = deconv(2, 2, kernel_size=4, stride=2, padding=1)
        self.upfeat4 = deconv(od + dd[2], 2, kernel_size=4, stride=2, padding=1)
        ...
        self.predict_flow3_2 = predict_flow(od + dd[2])
        self.deconv3 = deconv(2, 2, kernel_size=4, stride=2, padding=1)
        self.upfeat3 = deconv(od + dd[2], 2, kernel_size=4, stride=2, padding=1)
        ...
        self.predict_flow2_2 = predict_flow(od + dd[2])
        self.deconv2 = deconv(2, 2, kernel_size=4, stride=2, padding=1)
        self.upfeat2 = deconv(od + dd[2], 2, kernel_size=4, stride=2, padding=1)
    ...
    def forward(self, x):
        ...
        up_flow6 = self.predict_flow5_1(x) + up_flow6
        warp5 = self.warp(c25, up_flow6)
        corr5 = self.corr(c15, warp5)
        corr5 = self.leakyRELU(corr5)
        x = torch.cat((corr5, c15, up_flow6, up_feat6), 1)
        ...
        up_flow5 = self.predict_flow4_1(x) + up_flow5
        warp4 = self.warp(c24, up_flow5)
        corr4 = self.corr(c14, warp4)
        corr4 = self.leakyRELU(corr4)
        x = torch.cat((corr4, c14, up_flow5, up_feat5), 1)
        ...
        up_flow4 = self.predict_flow3_1(x) + up_flow4
        warp3 = self.warp(c23, up_flow4)
        corr3 = self.corr(c13, warp3)
        corr3 = self.leakyRELU(corr3)
        x = torch.cat((corr3, c13, up_flow4, up_feat4), 1)
        ...
        up_flow3 = self.predict_flow2_1(x) + up_flow3
        warp2 = self.warp(c22, up_flow3)
        corr2 = self.corr(c12, warp2)
        corr2 = self.leakyRELU(corr2)
        x = torch.cat((corr2, c12, up_flow3, up_feat3), 1)
